...
| abl_bot | run/abl_bot | 1e17353 | 42 | 100 | | | | row 2: BoT alone (POLLENBEES_ATTN=botnet), CIoU, stock BCE — only delta vs baseline (P5 C2f → BoTNet MHSA, 22.6M params). Awaiting run |
